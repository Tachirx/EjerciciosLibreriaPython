...
match opcion.lower():
    case "cesar":
        ...
        match operacion.lower():
            case "encriptar":
                from submodulo_encriptacion_cesar import encriptacion_cesar
                print(f"\n\nEl mensaje encriptado es: {encriptacion_cesar()}")
                print("\n===Fin del programa, hasta la proxima===")
            case "desencriptar":
                from submodulo_desencriptacion_cesar import desencriptacion_cesar
    ...
    case "vigenere":
        ...
        match operacion.lower():
            case "encriptar":
                from submodulo_encriptacion_vigenere import encriptar_vigenere
                print(f"\n\nEl mensaje encriptado es: {encriptar_vigenere()}")
                print("Fin del programa, hasta la proxima")
            case "desencriptar":
                from submodulo_desencriptacion_vigenere import desencriptar_vigenere
